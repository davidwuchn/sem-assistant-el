...
This capability defines watchdog behavior that supervises Emacs daemon liveness and triggers container restart recovery when sustained unresponsiveness is detected.
