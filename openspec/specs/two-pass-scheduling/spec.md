...
The provisional SCHEDULED from Pass 1 SHALL be treated as a hint only. Pass 2 MAY override it with different timing based on rules and existing schedule.
